...
import BatterShotAnalysis from '../components/BatterShotAnalysis';

function PlayerShotAnalysisPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-purple-100 text-lg mt-1">
              Shot Type Analysis & Control Metrics
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <BatterShotAnalysis player={player} />
      </div>
    </div>
  );
}

export default PlayerShotAnalysisPage;